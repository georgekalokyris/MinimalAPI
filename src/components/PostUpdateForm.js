...
export default function PostUpdateForm(props) {
    ...
    return (
        <form className='w-100 px-5'>
            <h1 className='mt-5'>Updateing post titled "{props.post.title}"</h1>
            ...
            <button onClick={() => props.onPostUpdated(null)} className="btn btn-warning btn-lg w-100 mt-3">Cancel</button>
        </form>
    );
}
